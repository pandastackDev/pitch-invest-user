						...
						<Card>
							...
							<CardBody className="pt-0">
								<Row className="icon-demo-content">
									...
									<Col xl={3} lg={4} sm={6}>
										<FeatherIcon icon="anchor" className="icon-dual-warning" />{" "}
										anchor
									</Col>

									<Col xl={3} lg={4} sm={6}>
										<FeatherIcon icon="aperture" className="icon-dual-danger" />{" "}
										aperture
									</Col>
									...
									<Col xl={3} lg={4} sm={6}>
										<FeatherIcon icon="clock" className="icon-dual-secondary" />{" "}
										clock
									</Col>
								</Row>
							</CardBody>
