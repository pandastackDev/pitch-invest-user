								...
								<div className="d-flex">
									...
									<div className="flex-grow-1">
										...
										<p className="text-muted">
											...
											is collected and recorded by Website Name and how we use
											it.
										</p>
										<p className="text-muted">
										...
										<p className="text-muted">
											...
											the information that they shared and/or collect in Website
											Name. This policy is not applicable to any information
