...
import { news, SearchGallery, swiper, video } from "../../../common/data";
									...
									<TabPane tabId="1">
										<div className="pb-3">
											...
											<p className="text-muted mb-2">
												...
												<span className="fw-semibold">bootstrap 5</span> stable
												...
												design in your existing project using Velzon it is very
												quick and easy as it is beautiful, adroit, and delivers
										...
										<div className="py-3">
											...
											<p className="text-muted mb-2">
												...
												template with Dark, Light Layouts with RTL options. You
												can build any type of web application like Saas based
												interface, eCommerce, Crypto, CRM, CMS, Project
										...
										<div className="py-3">
											...
											<p className="text-muted mb-2">
												...
												You can simply change to any layouts or mode by changing
										...
										<div className="py-3">
											...
											<p className="text-muted mb-2">
												...
												with Bootstrap ^5.1.3. It has 5+ different layouts and 3
												modes ( Dark, Light & RTL ) which are managed by SCSS
												only. You can simply change to any layouts or mode by
