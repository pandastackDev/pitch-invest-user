			...
			<Card>
				<CardBody className="p-4">
					...
					<p className="text-muted">
						...
						consistency is a MUST. If you’re not trying to create crazy contrast
						in your design, then a great idea would be for you to use a color
						palette throughout your entire design. It will subconsciously
						interest viewers and also is very pleasing to look at.{" "}
				...
				<CardBody className="p-4">
					...
					<SimpleBar style={{ height: "300px" }} className="px-3 mx-n3">
						...
						<div className="d-flex">
							...
							<div className="flex-grow-1 ms-3">
								<h5 className="fs-13">
									Alexis Clarke <small className="text-muted">26 min ago</small>
								</h5>
								<p className="text-muted">
									Your{" "}
									<Link to="#" className="text-decoration-underline">
