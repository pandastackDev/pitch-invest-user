				...
				<Row>
					<Col xl={6}>
						<Card>
							...
							<CardBody>
								<p className="text-muted">
									Use <code>data-simplebar-direction="rtl"</code> attribute and
									add <code>max-height: **px</code> to set simplebar at right
									side.
								</p>
						...
						<Row>
							<Col xl={4} lg={6}>
								<Card>
									...
									<CardBody>
										<p className="text-muted">
											Use <code>data-simplebar-track="primary"</code> attribute
											to set primary color simplebar track.
										</p>
											...
											>
												...
												>
													<div className="d-flex">
														...
														<div className="flex-shrink-0 ms-2">
															<div className="fs-11 text-muted">
																<i className="mdi mdi-clock-outline"></i> 01 hr
																ago
															</div>
														</div>
													</div>
												...
												>
													<div className="d-flex">
														...
														<div className="flex-shrink-0 ms-2">
															<div className="fs-11 text-muted">
																<i className="mdi mdi-clock-outline"></i> 02 hrs
																ago
															</div>
														</div>
													</div>
							...
							<Col xl={4} lg={6}>
								<Card>
									...
									<CardBody>
										<p className="text-muted">
											Use <code>data-simplebar-track="success"</code> attribute
											to set success color simplebar track.
										</p>
							...
							<Col xl={4} lg={6}>
								<Card>
									...
									<CardBody>
										<p className="text-muted">
											Use <code>data-simplebar-track="info"</code> attribute to
											set info color simplebar track.
										</p>
							...
							<Col xl={4} lg={6}>
								<Card>
									...
									<CardBody>
										<p className="text-muted">
											Use <code>data-simplebar-track="warning"</code> attribute
											to set warning color simplebar track.
										</p>
							...
							<Col xl={4} lg={6}>
								<Card>
									...
									<CardBody>
										<p className="text-muted">
											Use <code>data-simplebar-track="dark"</code> attribute to
											set dark color simplebar track.
										</p>
