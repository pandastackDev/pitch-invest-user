				...
				<Row>
					...
					<Col xl={4} lg={6}>
						<Card>
							...
							<CardBody>
								<p className="text-muted">
									Use <code>effect-fade-swiper</code> class to set a swiper with
									fade effect.
								</p>
					...
					<Col xl={4} lg={6}>
						<Card>
							...
							<CardBody>
								<p className="text-muted">
									Use <code>effect-creative-swiper</code> class to set a swiper
					...
					<Col xl={4} lg={6}>
						<Card>
							...
							<CardBody>
								<p className="text-muted">
									Use <code>effect-flip-swiper</code> class to set a swiper with
									flip effect.
								</p>
					...
					<Col lg={12}>
						<Card>
							...
							<CardBody>
								<p className="text-muted">
									Use <code>effect-coverflow-swiper</code> class to set a swiper
