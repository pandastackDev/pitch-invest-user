...
const CrmCompanies = () => {
	...
	const columns = useMemo(
		...
		[handleCompanyClick, checkedAll, deleteCheckbox, onClickDelete],
	);
						...
						<Card id="company-view-detail">
							...
							<div className="card-body">
								...
								<p className="text-muted mb-4">
									A company incurs fixed and variable costs such as the purchase
									of raw materials, salaries and overhead, as explained by
